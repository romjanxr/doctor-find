        ...
        <div className="register w-50 mx-auto mt-5">
            <div>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input type="password" placeholder="Re-enter Password" {...register("PasswordConfirm", { required: true, maxLength: 20 })} />
                    {errors.PasswordConfirm?.type === 'required' && <span className="text-danger">Password is required</span>}

    ...
    return (
        <div className="register w-50 mx-auto my-5">
            <div>
                ...
                <Link to="/login" className="text-danger" style={{ textDecoration: "none" }}>Already have An Account?</Link>
                <hr width="300px" />
                <button onClick={handleGoogleLogin} className="google-btn"><svg stroke="currentColor" fill="currentColor" strokeWidth="0" version="1.1" x="0px" y="0px" viewBox="0 0 48 48" enableBackground="new 0 0 48 48" className="w-6 h-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="#FFC107" d="M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12
